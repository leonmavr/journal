...
\item \url{https://math.stackexchange.com/questions/2464504/checking-the-nature-of-the-sequence-x-n-frac-left-lfloor-xn-right-rfloor?rq=1}
\end{enumerate}
}
...
\item
\item
Θέτουμε $\n+1=\mu \;\ \therefore\ \underset{n\to \infty }{\mathop{\lim }}\,\mu =\infty $, τότε η $\a_\n$ ξαναγράφεται
\[
\a_\n = \left(2 - \frac{\mu - 1}{\mu} \right)^{\mu-1} = \left(1 + \frac{1}{\mu} \right)^{\mu-1} 
\]
\[
\therefore \lim \left( {{\alpha }_{n}} \right)=\lim \left[ {{\left( 1+\frac{1}{m} \right)}^{m}}/\left( 1+\frac{1}{m} \right) \right]=e/1=e
\]
